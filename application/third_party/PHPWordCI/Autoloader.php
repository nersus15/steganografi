...
class PHPWordCI_Autoloader
{
	public static function Register() {
		return spl_autoload_register(array('PHPWordCI_Autoloader', 'Load'));
	}
	...
	public static function Load($strObjectName) {
		...
		// $tmp = explode('')
		$strObjectFilePath = PHPWORD_BASE_PATH . str_replace(['_', 'PHPWord'], ['/', 'PHPWordCI'], $strObjectName) . '.php';
