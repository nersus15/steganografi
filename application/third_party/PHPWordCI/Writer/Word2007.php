...
class PHPWord_Writer_Word2007 implements PHPWord_Writer_IWriter {
	...
	public function save($pFilename = null) {
		if(!is_null($this->_document)) {
            ...
            // Write static files
			$objZip->addFile(PHPWORD_BASE_PATH . 'PHPWordCI/_staticDocParts/numbering.xml', 'word/numbering.xml');
			$objZip->addFile(PHPWORD_BASE_PATH . 'PHPWordCI/_staticDocParts/settings.xml', 'word/settings.xml');
			$objZip->addFile(PHPWORD_BASE_PATH . 'PHPWordCI/_staticDocParts/theme1.xml', 'word/theme/theme1.xml');
			$objZip->addFile(PHPWORD_BASE_PATH . 'PHPWordCI/_staticDocParts/webSettings.xml', 'word/webSettings.xml');
			$objZip->addFile(PHPWORD_BASE_PATH . 'PHPWordCI/_staticDocParts/fontTable.xml', 'word/fontTable.xml');
